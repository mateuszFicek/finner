...
import '../common/template/domain/use_cases/get_template.dart' as _i16;
...
import '../features/account/domain/use_cases/authorize_with_google.dart'
    as _i14;
import '../features/account/domain/use_cases/create_user.dart' as _i15;
import '../features/account/domain/use_cases/login_user.dart' as _i17;
import '../features/account/presentation/bloc/account_bloc.dart' as _i18;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i5.FirebaseAuth>(firebaseClient.auth,
  ...
  gh.factory<_i15.CreateUser>(
      () => _i15.CreateUser(get<_i12.AccountRepository>()));
  gh.factory<_i16.GetTemplate>(
      () => _i16.GetTemplate(get<_i8.TemplateRepository>()));
  gh.factory<_i17.LoginUser>(
      () => _i17.LoginUser(get<_i12.AccountRepository>()));
  gh.singleton<_i18.AccountBloc>(_i18.AccountBloc(get<_i17.LoginUser>(),
      get<_i14.AuthorizeWithGoogle>(), get<_i15.CreateUser>()));
  return get;
}

class _$FirebaseClient extends _i19.FirebaseClient {}
